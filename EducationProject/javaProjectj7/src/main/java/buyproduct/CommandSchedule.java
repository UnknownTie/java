...
public class CommandSchedule implements CommandForm {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<ScheduleVO> vos = dao.getScheduleList(serial , ym);
		...
		request.setAttribute("ScheduleVOS", jArray.toString());
