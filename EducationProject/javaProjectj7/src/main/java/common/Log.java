...
//    System.out.println("MethodName  :  " + MethodName); // 에러 내용과 원인 출력 
	...
	public void logWriteClassCk(String LogData ,int nlevel) {
		String strLog = strClass + "\n ( " + strFuntion +" ) \n";
		strLog += strLog;
		LogWrite(strLog, nlevel);
	}
	public void logWriteClassCk(String LogData ,String Type) {
		String strLog = strClass + "\n ( " + strFuntion +" ) \n";
		strLog += strLog;
		LogWrite(strLog, Type);
	}
	...
	public void LogWrite(String strLog, String Type) {
		try {
	...
	public void LogWrite(String strLog, String strExplanation, String strType) {
		try {
			// 1. 폴더
			// 폴더 확인 및 생성
			FolderCheck(logfolder);
